...
import static software.kes.enhancediterables.EnhancedIterables.finiteIterable;
import static software.kes.enhancediterables.EnhancedIterables.unsafeImmutableNonEmptyFiniteIterable;
...
public interface EnhancedIterable<A> extends Iterable<A>, Functor<A, EnhancedIterable<?>> {
    ...
    /**
     * Returns an {@code Iterable} of contiguous groups of elements in this {@code EnhancedIterable} that match a
     * predicate pairwise.
     *
     * @param predicate the predicate function.
     *                  This function should be referentially transparent and not perform side-effects.
     *                  It may be called zero or more times for each element.
     * @return an {@code EnhancedIterable<NonEmptyIterable<A>>} containing the contiguous groups
     */
