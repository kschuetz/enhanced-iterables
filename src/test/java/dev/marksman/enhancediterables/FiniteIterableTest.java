...
class FiniteIterableTest {
    ...
    class Drop {
        ...
        @Test
        void countOfZero() {
            EnhancedIterable<Integer> subject = finiteIterable(asList(1, 2, 3));
    ...
    class Find {
        ...
        @Test
        void predicateSometimesTrue() {
            EnhancedIterable<Integer> subject = finiteIterable(asList(1, 2, 3, 4));
    ...
    class Partition {
        ...
        @Test
        void lambdaTestCase() {
            EnhancedIterable<String> strings = finiteIterable(asList("one", "two", "three", "four", "five"));
    ...
    class ZipWith {
        ...
        @Test
        void testCase1() {
            EnhancedIterable<Integer> list1 = finiteIterable(asList(1, 2, 3, 4, 5));
            EnhancedIterable<String> list2 = finiteIterable(asList("foo", "bar", "baz"));
